...
namespace BeehiveSimulator
{
    public class Renderer
    {
        ...
        public static Bitmap ResizeImage(Image ImageToResize, int Width, int Height)     //调整图像大小
        {
        ...
        Bitmap HiveInside;       //蜂巢内部图
        Bitmap HiveOutside;    //蜂巢外部图
        Bitmap Flower;            //花图
        Bitmap[] BeeAnimationSmall;   //小蜜蜂图片
        Bitmap[] BeeAnimationLarge;    //大蜜蜂图片
        ...
        public void PaintHive(Graphics g)     //画蜂巢
        {
        ...
        public void PaintField(Graphics g)    //画花场
        {
