...
namespace BeehiveSimulator
{
    ...
    public class Bee
    {
        private const double HoneyConsumed = 0.5;   //蜂蜜消耗
        private const int MoveRate = 3;  //移动步距(单位像素)
        private const double MinimumFlowerNectar = 1.5;  //一朵花最低花蜜量
        private const int CareerSpan = 1000;    //蜜蜂职业寿命
        private World world;
        private Hive hive;

        public int Age { get; private set; }   //年龄
        public bool InsideHive { get; private set; }     //是否在蜂巢
        public double NectarCollected { get; private set; }  //花蜜收集

        private Point location;      //位置
        public Point Location { get { return location; } }

        private int ID;   //编号
        private Flower destinationFlower;     //目的地花朵

        public BeeState CurrentState { get; private set; }   //蜜蜂状态
