...
namespace BeehiveSimulator
{
    ...
    public class World
    {
        private const double NectarHarvestedPerNewFlower = 50.0;   //花场每被采集50量的花蜜，增加一朵新花
        private const int FieldMinX = 15;    //花场最小X
        private const int FieldMinY = 177;   //花场最小Y
        private const int FieldMaxX = 690;  //花场最大X
        private const int FieldMaxY = 290;  //花场最大Y
